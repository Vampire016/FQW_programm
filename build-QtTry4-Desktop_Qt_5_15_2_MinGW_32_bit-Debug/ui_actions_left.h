/********************************************************************************
** Form generated from reading UI file 'actions_left.ui'
**
...
#ifndef UI_ACTIONS_LEFT_H
#define UI_ACTIONS_LEFT_H
...
public:
    ...
    void setupUi(QWidget *Actions_left)
    {
        if (Actions_left->objectName().isEmpty())
            Actions_left->setObjectName(QString::fromUtf8("Actions_left"));
        Actions_left->resize(1220, 183);
        QSizePolicy sizePolicy(QSizePolicy::Fixed, QSizePolicy::Preferred);
        sizePolicy.setHorizontalStretch(0);
        sizePolicy.setVerticalStretch(0);
        sizePolicy.setHeightForWidth(Actions_left->sizePolicy().hasHeightForWidth());
        Actions_left->setSizePolicy(sizePolicy);
        Actions_left->setMinimumSize(QSize(1220, 183));
        Actions_left->setMaximumSize(QSize(1220, 16777215));
        line = new QFrame(Actions_left);
        line->setObjectName(QString::fromUtf8("line"));
        line->setGeometry(QRect(10, 0, 1201, 16));
        line->setFrameShape(QFrame::HLine);
        line->setFrameShadow(QFrame::Sunken);
        layoutWidget = new QWidget(Actions_left);
        layoutWidget->setObjectName(QString::fromUtf8("layoutWidget"));
        layoutWidget->setGeometry(QRect(40, 20, 160, 129));
        ...
        pushButton_delAct = new QPushButton(Actions_left);
        ...
        groupBox_descr = new QGroupBox(Actions_left);
        ...
        sizePolicy3.setHeightForWidth(textEdit_descr_desc->sizePolicy().hasHeightForWidth());
        textEdit_descr_desc->setSizePolicy(sizePolicy3);
        ...
        groupBox_work = new QGroupBox(Actions_left);
        groupBox_work->setObjectName(QString::fromUtf8("groupBox_work"));
        groupBox_work->setGeometry(QRect(220, 20, 651, 151));
        ...
        sizePolicy4.setHeightForWidth(textEdit_work_desc->sizePolicy().hasHeightForWidth());
        textEdit_work_desc->setSizePolicy(sizePolicy4);
        ...
        groupBox_messege = new QGroupBox(Actions_left);
        groupBox_messege->setObjectName(QString::fromUtf8("groupBox_messege"));
        groupBox_messege->setGeometry(QRect(220, 20, 651, 151));
...
""));
        ...
        sizePolicy3.setHeightForWidth(textEdit_mess_text->sizePolicy().hasHeightForWidth());
        textEdit_mess_text->setSizePolicy(sizePolicy3);
        ...
        groupBox_agreement = new QGroupBox(Actions_left);
        groupBox_agreement->setObjectName(QString::fromUtf8("groupBox_agreement"));
        groupBox_agreement->setGeometry(QRect(220, 20, 651, 151));
        ...
        sizePolicy3.setHeightForWidth(textEdit_text_agree->sizePolicy().hasHeightForWidth());
        textEdit_text_agree->setSizePolicy(sizePolicy3);
        ...
        retranslateUi(Actions_left);

        QMetaObject::connectSlotsByName(Actions_left);
    } // setupUi

    void retranslateUi(QWidget *Actions_left)
    {
        Actions_left->setWindowTitle(QCoreApplication::translate("Actions_left", "Form", nullptr));
        label->setText(QString());
        label_curDate->setText(QCoreApplication::translate("Actions_left", "TextLabel", nullptr));
        label_2->setText(QString());
        label_cre_name->setText(QCoreApplication::translate("Actions_left", "TextLabel", nullptr));
        pushButton_delAct->setText(QString());
        groupBox_descr->setTitle(QString());
        label_descr_id->setText(QCoreApplication::translate("Actions_left", "TextLabel", nullptr));
        label_descr_title->setText(QCoreApplication::translate("Actions_left", "TextLabel", nullptr));
        groupBox_work->setTitle(QString());
        pushButton_editWork->setText(QString());
        checkBox_work->setText(QString());
        label_work_title->setText(QCoreApplication::translate("Actions_left", "TextLabel", nullptr));
        label_work_dates->setText(QCoreApplication::translate("Actions_left", "TextLabel", nullptr));
        label_work_worker->setText(QCoreApplication::translate("Actions_left", "TextLabel", nullptr));
        groupBox_messege->setTitle(QString());
        label_mess_helpdesk->setText(QCoreApplication::translate("Actions_left", "Helpdesk", nullptr));
        groupBox_agreement->setTitle(QString());
        groupBox_agreement_color->setTitle(QString());
        label_date_name_agree->setText(QCoreApplication::translate("Actions_left", "TextLabel", nullptr));
    } // retranslateUi

};

namespace Ui {
    class Actions_left: public Ui_Actions_left {};
} // namespace Ui

QT_END_NAMESPACE

#endif // UI_ACTIONS_LEFT_H
