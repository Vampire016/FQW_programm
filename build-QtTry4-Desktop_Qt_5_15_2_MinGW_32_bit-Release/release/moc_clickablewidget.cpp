...
#include <memory>
#include "../../QtTry4/clickablewidget.h"
...
QT_MOC_LITERAL(3, 25, 12) // "QMouseEvent*"
    ...
    "ClickableWidget\0clicked\0\0QMouseEvent*"
};
...
void ClickableWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (ClickableWidget::*)(QMouseEvent * );
...
// SIGNAL 0
void ClickableWidget::clicked(QMouseEvent * _t1)
{
