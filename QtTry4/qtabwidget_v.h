#ifndef QTABWIDGET_V_H
#define QTABWIDGET_V_H
...
class TabBarVert : public QTabBar
{
public:

    explicit TabBarVert(QWidget* parent=0) : QTabBar(parent)
    {
...
public:
    ...
    {
        setTabBar(new TabBarVert());
    }
};

#endif // QTABWIDGET_V_H
